...
The  directory contains metadata and logs for the GitField multi-repository publishing framework, designed to ensure sovereignty, redundancy, and resilience for the `shadowprint-velastra-collapse` project.
...
Generated by `gitfield-sync` at 2025-06-14T13:01:53Z (v1.5).
